...
from .utils import (admin_required,
                     _allowed_file, _format_duration,
...
# ── CLI – TIPOS DE ATENCIÓN ───────────────────────────────────────────────────
# (worker webapp + worker API routes moved to blueprints/nfc.py)
...
# NOTE: worker API routes (/api/worker/*, /api/nfc/*, /api/rooms, /api/residents,
# /api/care-types, /api/debug/record, /api/config, /uploads, /worker,
# /admin/settings, /login JWT) moved to blueprints/nfc.py
# ── ADMIN – RESIDENTES ────────────────────────────────────────────────────────
